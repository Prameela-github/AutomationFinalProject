...
public class Refresh 
{
	...
	public void MyAccount() {// to click on my account
		driver.findElement(MyAccount).click();
	}
	public void logindetails() {// to enter details

		driver.findElement(UserEmail).sendKeys("koradabhanu@gmail.com");
		driver.findElement(Password).sendKeys("koradabhanu");
	}
	public void login() {// to click on login
	...
	public void Attributes() throws InterruptedException {// to run the scenario
	...
	public void quit() {// to quit the browser
		driver.close();
	}
}
